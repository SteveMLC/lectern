...
Generated 2026-08-12 20:33 UTC by `pnpm usage:report`. Do not edit by hand — regenerate instead.

Ledger digest: `6257d67a34b0834a69a215c8450b03c10cf1899b32d11919e79115ddcfcda222` (174 entries). `pnpm usage:check` fails if this file no longer matches the ledger.
Receipt-allocation digest: `0f63616d19e6d4a4d4be125ea46596dffc5c9020b601b3718c1c87148d5c6b08` (28 records). Raw receipts remain private.

## The three numbers, kept separate

1. **Provider-reported tokens** — counters copied from local provider session logs.
2. **API-equivalent estimate — $1369.61** — those tokens at pinned public list prices ([pricing.json](pricing.json)). A workload gauge, not a bill.
3. **Actual billed spend — $465.13 evidenced so far** — the number a reimbursement claim uses, backed by 3 primary billing records plus 25 zero-dollar coverage extensions. 0 usage entries remain uncovered by recorded evidence.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| anthropic/claude-fable-5 | 57 | 1093 | 3,232 | 494,452,063 | 14,545,365 | 1,026,215 | $836.70 |
| anthropic/claude-opus-5 | 14 | 436 | 845,106 | 218,003,353 | 9,030,040 | 457,513 | $214.97 |
| openai/gpt-5.6-sol | 84 | — | 8,854,126 | 401,988,992 | 0 | 959,287 | $274.04 |
